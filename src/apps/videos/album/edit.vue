<template>
  <div class="abs bg-f flex c-6 f-14 app-video-album-edit">
    ...
    <template v-else>
      <div class="flex-item flex-col">
        ...
        <div class="flex-item scroll-y">
          <div class="video-album-editor">
            <div class="relative">
              <input v-model="form.title" class="title" type="text" placeholder="请输入标题"/>
            </div>
            <div class="selector">
              <div v-if="!videoList.length" class="selector-add flex-center a" @click="ui.videoSelectorShow = true;getList(true)">
                <i class="icon c-a" style="font-size: 80px;">video_call</i>
              </div>

              <div v-else>
                <ul class="list-view">
                  <li v-for="item in videoList" :key="item.id" class="list-item c-6 f-14 a flex-v-center">
...
.app-video-album-edit {
  ...
  .video-album-editor {max-width: 900px;margin: 0 auto;padding: 10px;
