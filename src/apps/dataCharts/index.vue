      ...
      <div class="data_box">
        ...
        <div v-if="top" class="data_item_box">
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;">{{ top.avgNewUsers }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;"><span style="margin-left: 5px;">{{ top.avgActiveUsers }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;">{{ top.newUsers }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;">{{ top.avgPushedCount }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;">{{ top.avgDuration }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;">{{ top.avgStartup }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;">{{ top.avgSended }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;">{{ top.avgDigg }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;">{{ top.avgPv }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>日均<span style="margin-left: 5px;">{{ top.avgShare }}</span></p>
          </div>
