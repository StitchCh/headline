      ...
      <div class="data_box">
        ...
        <div v-if="top" class="data_item_box">
          ...
          <div class="data_item">
            ...
            <p>日活<span style="margin-left: 5px;margin-right: 10px;">{{ top.avgActiveUsers }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>区间下载量<span style="margin-left: 5px;margin-right: 10px;">{{ top.intervalDownload }}</span></p>
          </div>
          ...
          <div class="data_item">
            ...
            <p>区间安装量<span style="margin-left: 5px;margin-right: 10px;">{{ top.intervalInstall }}</span></p>
          </div>
