<template>
  <div class="abs bg-f c-6 flex-col app-roles">
    ...
    <div v-if="loadingShow" class="loadbox">
      <loading size="80" color="#fff"></loading>
    </div>
          ...
          <div class="pie_lbox">
            ...
            <div class="pie_item">
              ...
              <div>
                ...
                <i v-if="browseData.pvRatioTrend == 1" style="color: #86ffa6;" class="icon">arrow_upward</i>
                <i v-else class="icon" style="color: #ff9089;">arrow_downward</i>
              </div>
            </div>
            ...
            <div class="pie_item">
              ...
              <div>
                ...
                <i v-if="browseData.uvRatioTrend == 1" style="color: #1aab7c;" class="icon">arrow_upward</i>
                <i v-else class="icon" style="color: #ff9089;">arrow_downward</i>
              </div>
            </div>
