<template>
  <div class="abs bg-f c-6 flex-col app-roles">
    ...
    <div class="flex-item scroll-y bg-e relative" style="padding: 40px 0;">
        ...
        <div v-if="browseData" class="flex">
          ...
          <div class="pie_lbox">
            ...
            <div class="pie_item">
              ...
              <div>
                同比 {{ browseData.pvRatio }}
                <i v-if="browseData.pvRatioTrend == 1" class="icon">arrow_upward</i>
                <i v-else class="icon">arrow_downward</i>
              </div>
            </div>
            ...
            <div class="pie_item">
              ...
              <div>
                同比 {{ browseData.uvRatio }}
                <i v-if="browseData.uvRatioTrend == 1" class="icon">arrow_upward</i>
                <i v-else class="icon">arrow_downward</i>
              </div>
            </div>
          ...
          <div class="pie_rbox" ref="echarts2"></div>
      ...
      <div class="data_box">
        ...
        <div class="data_title">
          <div style="font-size: 20px;font-weight: bold;">内容统计</div>
        ...
        <div style="margin-bottom: 20px;">
          ...
          <div class="setting-card f-14">
            <table>
              ...
              <tbody>
              <tr v-for="(item, index) in list1" :key="item.id" @click="openDetail(item.id)">
                <td>{{index + 1}}</td>
                <td>{{item.name}}</td>
                <td>{{item.content}}</td>
                <td>{{item.pv}}</td>
    ...
    methods: {
      ...
      getBrowse () {
        ...
        this.$http.post('/cri-cms-platform/appStatistics/browse.monitor', data).then(res => {
          ...
          this.browseData = res
          this.browseData.uvTrend.forEach((item, index) => {
            this.option2.xAxis.data.push(item.day)
            this.option2.series[1].data.push(item.value)
            this.option2.series[0].data.push(this.browseData.pvTrend[index].value)
          })
          this.$nextTick(() => {
...
<style scoped>
  ...
  .data_title .data_titleon{
    background: #00a0e9;
    color: #fff;
  }
  .data_title1 .data_titleon{
    background: #00a0e9;
    color: #fff;
  }
  .data_icon{
  ...
  .pie_item{
    font-size: 16px;
    font-weight: bold;
    background-image: linear-gradient(to right, #6d9ee6, #9198e5);
    border-radius: 8px;
    padding: 10px;
    color: #fff;
  }
