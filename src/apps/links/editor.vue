...
<div class="links-editor">
  ...
  <div class="linkbox" style="margin-bottom: 20px;">
    <div class="relative fl" style="width: 130px;">
      <div class="flex-v-center a account-toggler" @click="menuShow=!menuShow">
        <span>{{linkhead}}</span>
        <i class="icon">keyboard_arrow_down</i>
      </div>
      <bubble v-if="menuShow" class="c-6 headMenu" pos="bottom" align="center">
        <div class="account-menu">
          <div class="menu-item t-center a" @click="linkhead = 'http://';menuShow = false">http://</div>
          <div class="menu-item t-center a" @click="linkhead = 'https://';menuShow = false">https://</div>
        </div>
      </bubble>
    </div>
    <input v-model="link" class="link fr" type="text" placeholder="请输入链接">
  </div>

  <div style="width: 100%;">
    <iframe style="width: 100%;height: 600px;" :src="linkhead+link" frameborder="0"></iframe>
  </div>
...
.links-editor{
  ...
  .title{box-sizing: border-box;font-size: 30px;font-weight: bold;border: none;width: 100%;background: transparent;padding: 20px 15px;color: #555;margin-bottom: 20px;border-bottom: 1px solid #555;
